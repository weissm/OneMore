namespace River.OneMoreAddIn.Commands
{
	partial class PluginDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.optionTypeBox.Size = new System.Drawing.Size(181, 20);
			this.optionTypeBox.StylizeImage = false;
			this.optionTypeBox.TabIndex = 10;
			this.optionTypeBox.Text = "Enable getopts style args";
			this.optionTypeBox.ThemedBack = null;
			this.optionTypeBox.ThemedFore = null;
			this.optionTypeBox.UseVisualStyleBackColor = true;
			this.optionTypeBox.CheckedChanged += new System.EventHandler(this.optionTypeBox_CheckedChanged);
			// 
			// trialBox
			// 
